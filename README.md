...
<p>
  <a aria-label="NPM version" href="https://www.npmjs.com/package/@erboladaiorg/recusandae-autem-repudiandae">
    <img alt="" src="https://img.shields.io/npm/v/@erboladaiorg/recusandae-autem-repudiandae.svg?style=for-the-badge&labelColor=0869B8">
  </a>
  <a aria-label="License" href="#">
    <img alt="" src="https://img.shields.io/npm/l/@erboladaiorg/recusandae-autem-repudiandae.svg?style=for-the-badge&labelColor=579805">
  </a>
  <a aria-label="Thinkmill Logo" href="https://www.thinkmill.com.au/open-source?utm_campaign=github-@erboladaiorg/recusandae-autem-repudiandae">
...
```bash
npm install @erboladaiorg/recusandae-autem-repudiandae
```

Use with [Node.js](https://nodejs.org/en/), [Browserify](https://browserify.org/), or [webpack](https://webpack.github.io/):

```js
const classNames = require('@erboladaiorg/recusandae-autem-repudiandae');
...
There is also a [Changelog](https://github.com/erboladaiorg/recusandae-autem-repudiandae/blob/master/HISTORY.md).
...
```js
import React, { useState } from 'react';
import classNames from '@erboladaiorg/recusandae-autem-repudiandae';
...
```js
const classNames = require('@erboladaiorg/recusandae-autem-repudiandae/dedupe');
...
```js
const classNames = require('@erboladaiorg/recusandae-autem-repudiandae/bind');
...
import classNames from '@erboladaiorg/recusandae-autem-repudiandae/bind';
